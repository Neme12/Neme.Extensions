...
"${CC}" -dynamiclib -arch x86_64 -o "${OUTPUT_ROOT}/osx-x64/native/${LIB_NAME}" "${SOURCE_FILE}"
"${CC}" -dynamiclib -arch arm64 -o "${OUTPUT_ROOT}/osx-arm64/native/${LIB_NAME}" "${SOURCE_FILE}"
