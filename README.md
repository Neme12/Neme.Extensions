...
## Can I use this?
Feel free use any of this code or the packages in your project. No attribution necessary for my code, unless you're using code I copied from .NET repositories.

Access token for accessing packages: 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
