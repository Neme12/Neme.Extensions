...
public ref struct DefaultInterpolatedStringHandler
{
    ...
    public override string ToString() => StringPolyfill.Ctor(Text);
    ...
    {
        string result = StringPolyfill.Ctor(Text);
        Clear();
        return result;
    }
...
#pragma warning restore CA1508 // Avoid dead conditional code
    ...
    private void GrowCore(uint requiredMinCapacity)
    {
        ...
        uint newCapacity = Math.Max(requiredMinCapacity, Math.Min((uint)_chars.Length * 2, StringPolyfill.MaxLength));
