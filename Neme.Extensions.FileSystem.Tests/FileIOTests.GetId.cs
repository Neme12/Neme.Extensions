...
#pragma warning restore CS0649
        ...
        {
            // Act
            var result = FileIO.GetId(_tempFileHandle);
        ...
        public void WithDifferentFiles_ReturnsDifferentFileIds()
        {
            ...
            // Act
            var result1 = FileIO.GetId(_tempFileHandle);
            var result2 = FileIO.GetId(fileStream2.SafeFileHandle);
