...
public sealed class PartialFileTests
{
    ...
    public void Create_WithoutDeleteAccess_ThrowsArgumentException()
    {
        ...
        var options = FileOpenOptions.CreateNew(FileSystemAccess.ReadWrite, FileShare.All);
    ...
    {
        return new FileOpenOptions(mode, FileSystemAccess.ReadWrite | FileSystemAccess.Delete, FileShare.All);
    }
