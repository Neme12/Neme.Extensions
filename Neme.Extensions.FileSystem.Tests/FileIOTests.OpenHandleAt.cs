...
public sealed partial class FileIOTests
{
    ...
    public sealed class OpenHandleAt
    {
        ...
        public void BothParametersNull_ThrowsArgumentException()
        {
            ...
            string? path = null;
            var options = new FileCreateOptions(FileMode.Open, FileSystemAccess.ReadAttributes);
        ...
        public void RootDirectoryProvided_PathProvided_OpensRelativePath()
        {
            ...
            try
            {
                ...
                var dirOptions = new FileCreateOptions(FileMode.Open, FileSystemAccess.ReadAttributes)
                {
                    Attributes = FileAttributes.Directory
                };
                ...
                var fileName = Path.GetFileName(tempFile);
                var fileOptions = new FileCreateOptions(FileMode.Open, FileSystemAccess.ReadAttributes);
        ...
        public void CreateMode_CreatesNewFile()
        {
            ...
            {
                SafeFileHandle? rootDirectory = null;
                var options = new FileCreateOptions(FileMode.Create, FileSystemAccess.Write);
        ...
        public void DifferentAccessModes_OpensFile()
        {
            ...
            {
                SafeFileHandle? rootDirectory = null;
                var options = new FileCreateOptions(FileMode.Open, FileSystemAccess.Read);
        ...
        public void ShareModeNone_OpensFile()
        {
            ...
            {
                SafeFileHandle? rootDirectory = null;
                var options = new FileCreateOptions(FileMode.Open, FileSystemAccess.ReadAttributes, FileShare.None);
        ...
        public void OpenOrCreateMode_CreatesFileIfNotExists()
        {
            ...
            {
                SafeFileHandle? rootDirectory = null;
                var options = new FileCreateOptions(FileMode.OpenOrCreate, FileSystemAccess.Write);
        ...
        public void CombinedAccessFlags_OpensFile()
        {
            ...
            {
                SafeFileHandle? rootDirectory = null;
                var options = new FileCreateOptions(FileMode.Open, FileSystemAccess.Read | FileSystemAccess.Write);
        ...
        public void ShareModeReadWrite_OpensFile()
        {
            ...
            {
                SafeFileHandle? rootDirectory = null;
                var options = new FileCreateOptions(FileMode.Open, FileSystemAccess.ReadAttributes, FileShare.ReadWrite);
        ...
        public void CreateNewMode_CreatesNewFile()
        {
            ...
            {
                SafeFileHandle? rootDirectory = null;
                var options = new FileCreateOptions(FileMode.CreateNew, FileSystemAccess.Write);
        ...
        public void AppendMode_OpensFile()
        {
            ...
            {
                SafeFileHandle? rootDirectory = null;
                var options = new FileCreateOptions(FileMode.Append, FileSystemAccess.Write);
        ...
        public void TruncateMode_OpensExistingFile()
        {
            ...
            try
            {
                ...
                SafeFileHandle? rootDirectory = null;
                var options = new FileCreateOptions(FileMode.Truncate, FileSystemAccess.Write);
